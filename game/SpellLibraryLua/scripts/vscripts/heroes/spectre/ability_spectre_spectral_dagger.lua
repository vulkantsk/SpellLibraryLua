LinkLuaModifier( "modifier_ability_spectre_spectral_dagger_dummy_proj", "heroes/spectre/ability_spectre_spectral_dagger" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_spectre_spectral_path", "heroes/spectre/ability_spectre_spectral_dagger" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_spectre_spectral_in_path", "heroes/spectre/ability_spectre_spectral_dagger" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_spectre_spectral_grace", "heroes/spectre/ability_spectre_spectral_dagger" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_spectre_spectral_path_by_heroes", "heroes/spectre/ability_spectre_spectral_dagger" ,LUA_MODIFIER_MOTION_NONE )

if ability_spectre_spectral_dagger == nil then
    ability_spectre_spectral_dagger = class({})
end

--------------------------------------------------------------------------------

function ability_spectre_spectral_dagger:OnSpellStart()
    ...
    if target and target:IsHero() then
        ...
        dummy:AddNewModifier(caster, self, "modifier_ability_spectre_spectral_dagger_dummy_proj", {})
    else
...
function ability_spectre_spectral_dagger:OnProjectileHit(Target, Location)
...
function ability_spectre_spectral_dagger:OnProjectileThink(vLocation)
    local caster = self:GetCaster()

    CreateModifierThinker(caster, self, "modifier_ability_spectre_spectral_path", {duration = self:GetSpecialValueFor('dagger_path_duration')}, vLocation, caster:GetTeam(), false)
end

--------------------------------------------------------------------------------


modifier_ability_spectre_spectral_dagger_dummy_proj = class({
...
if IsServer() then
function modifier_ability_spectre_spectral_dagger_dummy_proj:OnCreated()
...
function modifier_ability_spectre_spectral_dagger_dummy_proj:OnIntervalThink()
...
function modifier_ability_spectre_spectral_dagger_dummy_proj:GetAbsoluteNoDamageMagical() return 1 end
function modifier_ability_spectre_spectral_dagger_dummy_proj:GetAbsoluteNoDamagePure() return 1 end
function modifier_ability_spectre_spectral_dagger_dummy_proj:GetAbsoluteNoDamagePhysical() return 1 end
...
function modifier_ability_spectre_spectral_path_by_heroes:OnIntervalThink()
    ...
    CreateModifierThinker(caster, self:GetAbility(), "modifier_ability_spectre_spectral_path", {duration = self.dagger_path_duration}, self:GetParent():GetAbsOrigin(), caster:GetTeam(), false)
end
end
...
--[[
function ability_spectre_spectral_dagger:OnProjectileThink_ExtraData(vLocation, ExtraData)
