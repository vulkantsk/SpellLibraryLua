LinkLuaModifier( "modifier_ability_bloodseeker_blood_bath_thinker", "heroes/bloodseeker/bloodseeker_blood_bath" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_bloodseeker_blood_bath", "heroes/bloodseeker/bloodseeker_blood_bath" ,LUA_MODIFIER_MOTION_NONE )
